...
# Developing noyalib-mcp

noyalib-mcp is a satellite of the [noyalib](https://github.com/sebastienrousseau/noyalib)
...
```bash
git clone https://github.com/sebastienrousseau/noyalib-mcp
cd noyalib-mcp
cargo test
```
